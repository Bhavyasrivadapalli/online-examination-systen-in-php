    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Bhavyasri Vadapalli</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9398003497</h4>
		<h4 style="font-family:'typo' ">bhavyasrivadapalli@gmail.com</h4>
		<h4 style="font-family:'typo' ">RAJIV GANDHI UNIVERSITY OF KNOWLEDGE AND TECHNOLOGIES</h4></div></div>
		</p>
      </div>
